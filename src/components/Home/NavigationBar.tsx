...
export const NavigationBar = ({textColor,hoverColor,text=null}:navigationBar) => {
  
  return (
    <div>
      {menuItems.map((item, index) => (
        <div key={index}>
          <h4 className={`${textColor} text-[#92959b]  text-left text-xs font-bold `}>{text? text : item.category}</h4>
